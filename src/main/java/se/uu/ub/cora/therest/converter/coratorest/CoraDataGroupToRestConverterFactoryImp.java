...
public class CoraDataGroupToRestConverterFactoryImp implements CoraDataGroupToRestConverterFactory {

	@Override
	public CoraToRestConverter factorForDataGroupWithConverterInfo(DataGroup dataGroup,
			ConverterInfo converterInfo) {
		return CoraDataGroupToRestConverter
	...
	public CoraActionToRestConverter factorForActionsUsingConverterInfoAndDataGroup(
		...
		return CoraActionToRestConverterImp.fromDataActionsWithConverterInfoAndDataGroup(
