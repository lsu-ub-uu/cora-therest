...
public final class JsonDataAtomicToRestConverter implements JsonToRestConverter {
	...
	static JsonDataAtomicToRestConverter forJsonObject(JsonObject jsonObject) {
		return new JsonDataAtomicToRestConverter(jsonObject);
	}

	private JsonDataAtomicToRestConverter(JsonObject jsonObject) {
