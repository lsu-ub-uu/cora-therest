...
public class JsonDataResourceLinkToRestConverter extends JsonDataGroupToRestConverter
		implements JsonToRestConverter {

	private static final int NUM_OF_RESOURCELINK_CHILDREN = 4;

	private JsonDataResourceLinkToRestConverter(JsonObject jsonObject) {
		super(jsonObject);
	}
	...
	public static JsonDataResourceLinkToRestConverter forJsonObject(JsonObject jsonObject) {
		return new JsonDataResourceLinkToRestConverter(jsonObject);
	}
