...
public final class RestDataListToJsonConverter implements RestToJsonConverter {

	private JsonBuilderFactory jsonBuilderFactory;
	private RestDataList restRecordList;
	private JsonObjectBuilder recordListJsonObjectBuilder;

	public static RestDataListToJsonConverter usingJsonFactoryForRestDataList(
			JsonBuilderFactory jsonFactory, RestData restRecordList) {
		return new RestDataListToJsonConverter(jsonFactory, restRecordList);
	}

	private RestDataListToJsonConverter(JsonBuilderFactory jsonFactory, RestData restRecordList) {
	...
	private void convertRestGroupToJsonBuilder(JsonArrayBuilder recordsJsonBuilder,
			RestData restData) {
		RestDataGroupToJsonConverter converter = RestDataGroupToJsonConverter
