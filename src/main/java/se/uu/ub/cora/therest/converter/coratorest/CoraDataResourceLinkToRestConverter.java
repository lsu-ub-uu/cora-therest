...
public final class CoraDataResourceLinkToRestConverter extends CoraDataGroupToRestConverter {
	private DataResourceLink dataResourceLink;
	private RestDataResourceLink restDataResourceLink;

	public static CoraDataResourceLinkToRestConverter fromDataResourceLinkWithConverterInfo(
			DataResourceLink dataResourceLink, ConverterInfo converterInfo) {
		return new CoraDataResourceLinkToRestConverter(dataResourceLink, converterInfo);
	}

	private CoraDataResourceLinkToRestConverter(DataResourceLink dataResourceLink,
