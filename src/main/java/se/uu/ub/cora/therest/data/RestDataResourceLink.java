...
public final class RestDataResourceLink extends RestDataGroup {

	private Map<String, ActionLink> actionLinks = new LinkedHashMap<>();

	public static RestDataResourceLink withNameInData(String nameInData) {
		return new RestDataResourceLink(nameInData);
	}

	private RestDataResourceLink(String nameInData) {
		super(nameInData);
	}
