...
public final class RestDataAtomicToJsonConverter implements RestToJsonConverter {

	private RestDataAtomic restDataAtomic;
	private JsonBuilderFactory factory;

	public static RestToJsonConverter usingJsonFactoryForRestDataAtomic(
			JsonBuilderFactory factory, RestDataAtomic dataAtomic) {
		return new RestDataAtomicToJsonConverter(factory, dataAtomic);
	}

	private RestDataAtomicToJsonConverter(JsonBuilderFactory factory, RestDataAtomic dataAtomic) {
