...
public class JsonDataGroupToRestConverter implements JsonToRestConverter {
	...
	static JsonDataGroupToRestConverter forJsonObject(JsonObject jsonObject) {
		return new JsonDataGroupToRestConverter(jsonObject);
	}

	protected JsonDataGroupToRestConverter(JsonObject jsonObject) {
	...
	private void addChildToGroup(JsonObject child) {
		JsonToRestConverterFactoryImp jsonToDataConverterFactoryImp = new JsonToRestConverterFactoryImp();
		JsonToRestConverter childJsonToDataConverter = jsonToDataConverterFactoryImp
