...
public final class CoraDataAtomicToRestConverter {

	private DataAtomic dataAtomic;

	public static CoraDataAtomicToRestConverter fromDataAtomic(
			DataAtomic dataAtomic) {
		return new CoraDataAtomicToRestConverter(dataAtomic);
	}

	private CoraDataAtomicToRestConverter(DataAtomic dataAtomic) {
