...
public final class JsonDataAttributeToRestConverter implements JsonToRestConverter {

	private JsonObject jsonObject;

	static JsonDataAttributeToRestConverter forJsonObject(JsonObject jsonObject) {
		return new JsonDataAttributeToRestConverter(jsonObject);
	}

	private JsonDataAttributeToRestConverter(JsonObject jsonObject) {
