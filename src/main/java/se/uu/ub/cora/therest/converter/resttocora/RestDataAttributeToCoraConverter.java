...
public final class RestDataAttributeToCoraConverter {
	public static RestDataAttributeToCoraConverter fromRestDataAttribute(
			RestDataAttribute restDataAttribute) {
		return new RestDataAttributeToCoraConverter(restDataAttribute);
	}

	private RestDataAttribute restDataAttribute;

	private RestDataAttributeToCoraConverter(RestDataAttribute restDataAttribute) {
