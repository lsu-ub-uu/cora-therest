...
public class RestDataActionLinkToJsonConverter implements RestToJsonConverter {

	private Map<String, ActionLink> actionLinks;
	private JsonBuilderFactory jsonBuilderFactory;
	private JsonObjectBuilder actionLinksObject;

	public RestDataActionLinkToJsonConverter(JsonBuilderFactory jsonBuilderFactory,
	...
	private void possiblyAddBodyToBuilder(ActionLink actionLink,
		...
		if (actionLinkHasBody(actionLink)) {
			RestDataGroupToJsonConverter dataGroupToJsonConverter = RestDataGroupToJsonConverter
