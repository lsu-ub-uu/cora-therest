...
public final class RestDataRecordLinkToJsonConverter extends RestDataGroupToJsonConverter {

	private static final String LINKED_REPEAT_ID = "linkedRepeatId";
	private RestDataRecordLink recordLink;

	private RestDataRecordLinkToJsonConverter(JsonBuilderFactory jsonFactory,
			RestDataRecordLink recordLink) {
		super(jsonFactory, recordLink);
		this.recordLink = recordLink;
	}

	public static RestDataRecordLinkToJsonConverter usingJsonFactoryForRestDataLink(
			JsonBuilderFactory jsonFactory, RestDataRecordLink dataLink) {
		return new RestDataRecordLinkToJsonConverter(jsonFactory, dataLink);
	}
