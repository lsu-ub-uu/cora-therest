...
public class RestDataGroupToJsonConverter implements RestToJsonConverter {
	...
	protected RestDataGroupToJsonConverter(JsonBuilderFactory jsonBuilderFactory,
	...
	public static RestDataGroupToJsonConverter usingJsonFactoryForRestDataGroup(
			JsonBuilderFactory factory, RestDataGroup restDataGroup) {
		return new RestDataGroupToJsonConverter(factory, restDataGroup);
	}
	...
	private void addChildrenToGroup() {
		...
		for (RestDataElement restDataElement : restDataGroup.getChildren()) {
			RestToJsonConverter restToJsonConverter = dataToJsonConverterFactory
