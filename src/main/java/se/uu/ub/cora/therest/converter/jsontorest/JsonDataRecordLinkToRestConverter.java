...
public final class JsonDataRecordLinkToRestConverter extends JsonDataGroupToRestConverter
	...
	static JsonDataRecordLinkToRestConverter forJsonObject(JsonObject jsonObject) {
		return new JsonDataRecordLinkToRestConverter(jsonObject);
	}

	private JsonDataRecordLinkToRestConverter(JsonObject jsonObject) {
		super(jsonObject);
	}
