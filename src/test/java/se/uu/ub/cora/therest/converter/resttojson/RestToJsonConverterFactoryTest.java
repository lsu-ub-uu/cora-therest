...
public class RestToJsonConverterFactoryTest {
	private RestToJsonConverterFactory dataToJsonConverterFactory;
	private JsonBuilderFactory factory;

	@BeforeMethod
	public void beforeMethod() {
		dataToJsonConverterFactory = new RestToJsonConverterFactoryImp();
	...
	public void testJsonCreatorFactoryDataGroup() {
		...
		assertTrue(dataToJsonConverter instanceof RestDataGroupToJsonConverter);
	}
	...
	public void testJsonCreatorFactoryDataAtomic() {
		...
		assertTrue(dataToJsonConverter instanceof RestDataAtomicToJsonConverter);
	}
	...
	public void testJsonCreatorFactoryDataAttribute() {
		...
		assertTrue(dataToJsonConverter instanceof RestDataAttributeToJsonConverter);
	}
	...
	public void testJsonCreateFactoryDataRecordLink() {
		...
		assertTrue(dataToJsonConverter instanceof RestDataRecordLinkToJsonConverter);
	...
	public void testJsonCreateFactoryDataResourceLink() {
		...
		assertTrue(dataToJsonConverter instanceof RestDataResourceLinkToJsonConverter);
	...
	public void testFactorDataListToJsonConverter() {
		...
		RestDataListToJsonConverter converter = (RestDataListToJsonConverter) dataToJsonConverterFactory
