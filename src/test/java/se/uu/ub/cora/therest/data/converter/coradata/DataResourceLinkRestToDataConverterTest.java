...
public class DataResourceLinkRestToDataConverterTest {
	...
	public void testConverterExtendsDataGroupConverter() {
		DataResourceLinkRestToDataConverter converter = DataResourceLinkRestToDataConverter
				.fromRestDataGroup(null);
		assertTrue(converter instanceof DataGroupRestToDataConverter);
	}
