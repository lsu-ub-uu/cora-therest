...
import se.uu.ub.cora.therest.coradata.DataAtomicFactorySpy;
import se.uu.ub.cora.therest.data.RestDataAtomic;

public class RestDataAtomicToCoraConverterTest {
	private RestDataAtomic restDataAtomic;
	private RestDataAtomicToCoraConverter converter;
	...
	public void setUp() {
		...
		converter = RestDataAtomicToCoraConverter.fromRestDataAtomic(restDataAtomic);
