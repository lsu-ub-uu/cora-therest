...
public class RestDataAtomicToJsonConverterTest {
	private RestDataAtomic restDataAtomic;
	private RestToJsonConverter converter;
	...
	public void beforeMethod() {
		...
		converter = RestDataAtomicToJsonConverter.usingJsonFactoryForRestDataAtomic(factory,
				restDataAtomic);
	}
