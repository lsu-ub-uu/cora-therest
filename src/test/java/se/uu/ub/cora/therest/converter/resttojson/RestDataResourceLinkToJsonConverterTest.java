...
public class RestDataResourceLinkToJsonConverterTest {
	private RestDataResourceLink resourceLink;
	private RestDataResourceLinkToJsonConverter converter;
	...
	public void setUp() {
		...
		converter = RestDataResourceLinkToJsonConverter.usingJsonFactoryForRestDataLink(jsonFactory,
				resourceLink);
