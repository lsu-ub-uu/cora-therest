...
public class RestDataRecordLinkToJsonConverterTest {
	private RestDataRecordLink recordLink;
	private RestDataRecordLinkToJsonConverter converter;
	...
	public void setUp() {
		...
		converter = RestDataRecordLinkToJsonConverter.usingJsonFactoryForRestDataLink(jsonFactory,
				recordLink);
