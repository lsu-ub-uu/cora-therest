...
public class JsonToRestConverterFactoryTest {
	private JsonToRestConverterFactory jsonToDataConverterFactory;
	private JsonParser jsonParser;

	@BeforeMethod
	public void beforeMethod() {
		jsonToDataConverterFactory = new JsonToRestConverterFactoryImp();
	...
	public void testFactorOnJsonStringDataGroupEmptyChildren() {
		...
		assertTrue(jsonToDataConverter instanceof JsonDataGroupToRestConverter);
	}
	...
	public void testFactorOnJsonStringDataAtomic() {
		...
		JsonToRestConverter jsonToDataConverter = jsonToDataConverterFactory
				.createForJsonObject(jsonValue);
		assertTrue(jsonToDataConverter instanceof JsonDataAtomicToRestConverter);
	}
	...
	public void testFactorOnJsonStringDataAttribute() {
		...
		JsonToRestConverter jsonToDataConverter = jsonToDataConverterFactory
				.createForJsonObject(jsonValue);
		assertTrue(jsonToDataConverter instanceof JsonDataAttributeToRestConverter);
	}
	...
	public void testFactorOnJsonStringCompleteSetupFactorsDataRecordLink() {
		...
		JsonToRestConverter jsonToDataConverter = jsonToDataConverterFactory
				.createForJsonObject(jsonValue);
		assertTrue(jsonToDataConverter instanceof JsonDataRecordLinkToRestConverter);
	}
	...
	public void testFactorOnJsonStringCompleteSetupFactorsDataResourceLink() {
		...
		JsonToRestConverter jsonToDataConverter = jsonToDataConverterFactory
				.createForJsonObject(jsonValue);
		assertTrue(jsonToDataConverter instanceof JsonDataResourceLinkToRestConverter);
	}
