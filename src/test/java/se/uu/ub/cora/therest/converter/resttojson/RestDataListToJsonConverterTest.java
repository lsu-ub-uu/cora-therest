...
public class RestDataListToJsonConverterTest {
	@Test
	public void testToJson() {
		...
		RestDataListToJsonConverter recordListToJsonConverter = RestDataListToJsonConverter.usingJsonFactoryForRestDataList(jsonFactory, restDataList);
